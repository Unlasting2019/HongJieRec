...
def ple_layer(
    ...
    def cgc_unit(inp, prefix, is_last=False):
        ...
        share_expert /= (tf.math.reduce_std(share_expert, -1, True)+1e-12)
    ...
    share_inp /= (tf.math.reduce_std(share_inp, -1, True)+1e-12)
